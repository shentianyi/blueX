...
class PicksControllerTest < ActionController::TestCase
  ...
  test "should create pick" do
    assert_difference('Pick.count') do
      post :create, pick: { remarks: @pick.remarks, status: @pick.status, user_id: @pick.user_id, warehouse_id: @pick.warehouse_id }
    end
  ...
  test "should update pick" do
    patch :update, id: @pick, pick: { remarks: @pick.remarks, status: @pick.status, user_id: @pick.user_id, warehouse_id: @pick.warehouse_id }
    assert_redirected_to pick_path(assigns(:pick))
  end
