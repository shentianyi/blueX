...
class ColorsControllerTest < ActionController::TestCase
  ...
  test "should create color" do
    assert_difference('Color.count') do
      post :create, color: { description: @color.description, name: @color.name, nr: @color.nr, short_name: @color.short_name }
    end
  ...
  test "should update color" do
    patch :update, id: @color, color: { description: @color.description, name: @color.name, nr: @color.nr, short_name: @color.short_name }
    assert_redirected_to color_path(assigns(:color))
  end
