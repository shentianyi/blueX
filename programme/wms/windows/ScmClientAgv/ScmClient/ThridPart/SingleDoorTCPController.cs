...
namespace ScmClient.ThridPart
{
   public class SingleDoorTCPControllerBase
   {
       #region constdata
       ...
       public SingleDoorTCPControllerBase()
       {
   ...
   public class SingleDoorTCPController : SingleDoorTCPControllerBase
   {
       #region 参数类指令
